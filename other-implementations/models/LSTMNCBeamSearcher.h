/*
 * LSTMNCBeamSearcher.h
 *
 *  Created on: Jan 25, 2016
 *      Author: mszhang
 */

#ifndef SRC_LSTMNCBeamSearcher_H_
#define SRC_LSTMNCBeamSearcher_H_
	...
	dtype trainOneExample(const std::vector<std::string>& sentence, const vector<CAction>& goldAC, int num) {
		...
		while (true) {
			...
			if (!bCorrect) {
				...
				for(int idx = 0; idx < length; idx++){
					charFeat._charpre_Loss[idx] = 0.0;
					charFeat._charpre_Loss[idx] = 0.0;
...
#endif /* SRC_LSTMNCBeamSearcher_H_ */
