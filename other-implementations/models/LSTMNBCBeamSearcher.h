/*
 * LSTMNBCBeamSearcher.h
 *
 *  Created on: Jan 25, 2016
 *      Author: mszhang
 */

#ifndef SRC_LSTMNBCBeamSearcher_H_
#define SRC_LSTMNBCBeamSearcher_H_
		...
		while (true) {
			...
			if (!bCorrect) {
				...
				for(int idx = 0; idx < length; idx++){
					...
					charFeat._bicharprime_Loss[idx] = 0.0;
...
#endif /* SRC_LSTMNBCBeamSearcher_H_ */
