...
#ifndef SRC_GRNNBeamSearcher_H_
#define SRC_GRNNBeamSearcher_H_
...
public:
	...
	GRNN<xpu> _char_left_rnn;
	GRNN<xpu> _char_right_rnn;
	GRNN<xpu> _word_increased_rnn;
	GRNN<xpu> _action_increased_rnn;
...
public:
	...
	dtype trainOneExample(const std::vector<std::string>& sentence, const vector<CAction>& goldAC, int num) {
		...
		_char_left_rnn.ComputeForwardScore(charFeat._charHidden, charFeat._charLeftRNNHiddenBuf[0], charFeat._charLeftRNNHiddenBuf[1], charFeat._charLeftRNNHiddenBuf[2],
				charFeat._charLeftRNNHiddenBuf[3], charFeat._charLeftRNNHidden);
		_char_right_rnn.ComputeForwardScore(charFeat._charHidden, charFeat._charRightRNNHiddenBuf[0], charFeat._charRightRNNHiddenBuf[1], charFeat._charRightRNNHiddenBuf[2],
				charFeat._charRightRNNHiddenBuf[3], charFeat._charRightRNNHidden);
		...
		while (true) {
				...
				for (tmp_j = 0; tmp_j < actions.size(); ++tmp_j) {
					...
					if (pGenerator->_nextPosition == 0) {
						_action_increased_rnn.ComputeForwardScoreIncremental(scored_action.nnfeat._actionHidden,
								scored_action.nnfeat._actionRNNHiddenBuf[0], scored_action.nnfeat._actionRNNHiddenBuf[1], scored_action.nnfeat._actionRNNHiddenBuf[2], scored_action.nnfeat._actionRNNHiddenBuf[3],
					...
					if (scored_action.action._code == CAction::SEP || scored_action.action._code == CAction::FIN) {
						...
						if (preSepState == 0) {
							_word_increased_rnn.ComputeForwardScoreIncremental(scored_action.nnfeat._wordHidden,
									scored_action.nnfeat._wordRNNHiddenBuf[0], scored_action.nnfeat._wordRNNHiddenBuf[1], scored_action.nnfeat._wordRNNHiddenBuf[2], scored_action.nnfeat._wordRNNHiddenBuf[3],
			...
			if (!bCorrect) {
				...
				_char_left_rnn.ComputeBackwardLoss(charFeat._charHidden,
						charFeat._charLeftRNNHiddenBuf[0], charFeat._charLeftRNNHiddenBuf[1], charFeat._charLeftRNNHiddenBuf[2], charFeat._charLeftRNNHiddenBuf[3],
						charFeat._charLeftRNNHidden, charFeat._charLeftRNNHidden_Loss, charFeat._charHidden_Loss);
				_char_right_rnn.ComputeBackwardLoss(charFeat._charHidden,
						charFeat._charRightRNNHiddenBuf[0], charFeat._charRightRNNHiddenBuf[1], charFeat._charRightRNNHiddenBuf[2], charFeat._charRightRNNHiddenBuf[3],
						charFeat._charRightRNNHidden, charFeat._charRightRNNHidden_Loss, charFeat._charHidden_Loss);
	...
	void backPropagationStates(const CStateItem<xpu> *pPredState, const CStateItem<xpu> *pGoldState, dtype predLoss, dtype goldLoss,
		...
		if (pPredState->_nextPosition == 0) {
			...
			_word_increased_rnn.ComputeBackwardLoss(predDenseFeature._wordHidden,
					predDenseFeature._wordRNNHiddenBuf[0], predDenseFeature._wordRNNHiddenBuf[1], predDenseFeature._wordRNNHiddenBuf[2], predDenseFeature._wordRNNHiddenBuf[3],
			...
			_action_increased_rnn.ComputeBackwardLoss(predDenseFeature._actionHidden,
					predDenseFeature._actionRNNHiddenBuf[0], predDenseFeature._actionRNNHiddenBuf[1], predDenseFeature._actionRNNHiddenBuf[2], predDenseFeature._actionRNNHiddenBuf[3],
			...
			_word_increased_rnn.ComputeBackwardLoss(goldDenseFeature._wordHidden,
					goldDenseFeature._wordRNNHiddenBuf[0], goldDenseFeature._wordRNNHiddenBuf[1], goldDenseFeature._wordRNNHiddenBuf[2], goldDenseFeature._wordRNNHiddenBuf[3],
			...
			_action_increased_rnn.ComputeBackwardLoss(goldDenseFeature._actionHidden,
					goldDenseFeature._actionRNNHiddenBuf[0], goldDenseFeature._actionRNNHiddenBuf[1], goldDenseFeature._actionRNNHiddenBuf[2], goldDenseFeature._actionRNNHiddenBuf[3],
