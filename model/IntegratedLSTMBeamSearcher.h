/*
 * IntegratedLSTMBeamSearcher.h
 *
 *  Created on: Jan 25, 2016
 *      Author: mszhang
 */

#ifndef SRC_IntegratedLSTMBeamSearcher_H_
#define SRC_IntegratedLSTMBeamSearcher_H_
...
class IntegratedLSTMBeamSearcher {
public:
	IntegratedLSTMBeamSearcher() {
		_dropOut = 0.5;
		_delta = 0.2;
		_oovRatio = 0.2;
		_oovFreq = 3;
...
public:
	...
	inline void init(const NRMat<dtype>& wordEmb, const NRMat<dtype>& allwordEmb, const NRMat<dtype>& lengthEmb, int wordNgram, int wordHiddenSize, int wordRNNHiddenSize,
		...
		_splayer_output.initial(_linearfeatSize, 200);
...
#endif /* SRC_IntegratedLSTMBeamSearcher_H_ */
